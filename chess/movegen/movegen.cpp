        ...
        if (C == WHITE) {
            if (piece == PAWN) {
                ...
                while(b1) {
                    ...
                    if ( (targetSquare <= H8) && !getBit(bitboards[BOTH_OCC], targetSquare) ) {
                        ...
                        if ( (startSquare >= A7) && (startSquare <= H7) ) {
                            ...
                            // two square ahead
                            if ( (startSquare >= A2) && (startSquare <= H2) && !getBit(bitboards[BOTH_OCC], targetSquare + 8)) {
            ...
            if (piece == (PAWN + 6) ) { // loop over WHITE pawn b1
                ...
                while(b1) {
                    ...
                    if ( (targetSquare >= A1) && !getBit(bitboards[BOTH_OCC], targetSquare) ) {
                        // pawn promotion, maybe change this to row check or something?
                        if ( (startSquare >= A2) && (startSquare <= H2) ) {
                            ...
                            // two squares ahead
                            if ( (startSquare >= A7) && (startSquare <= H7) && !getBit(bitboards[BOTH_OCC], targetSquare - 8)) {
                                addMove(moveList, Move(startSquare, targetSquare - 8, DOUBLE_PUSH) );
                            }
                        }
                    }
